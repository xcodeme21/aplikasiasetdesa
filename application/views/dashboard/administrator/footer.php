                ...
                <div class="modal fade" id="ubahPasswordModal">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="<?= base_url('index.php/administrator/doUpdatePassword') ?>" method="post">
                ...
                <div class="modal fade" id="keluarModal">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-dismiss="modal">Tutup</button>
                                <button type="button" class="btn btn-success" onclick="return window.location='<?= base_url('index.php/administrator/doLogout') ?>';">Ya</button>
                            </div>
                        </div>
                    </div>
                </div>
