    ...
    <body>
        ...
        <div id="main-wrapper">
            <div class="nav-header">
                <a href="<?= base_url('index.php/administrator') ?>" class="brand-logo">
                    ...
                    <ul class="metismenu" id="menu">
                        ...
                        <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="mdi mdi-printer"></i><span class="nav-text">Tools dan Cetak</span></a>
                            <ul aria-expanded="false">
                                <li><a href="<?= base_url('index.php/administrator/assets/deleted') ?>">Aset Desa Yg Dihapus</a></li>
                                <li><a href="<?= base_url('index.php/administrator/assets') ?>">Inventaris Aset Desa</a></li>
                                <li><a href="<?= base_url('index.php/administrator/assets/status') ?>">Status Penggunaan Aset Desa</a></li>
                            </ul>
                        </li>
                        <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="nav-text">Users</span></a>
                            <ul aria-expanded="false">
                                <li><a href="<?= base_url('index.php/administrator/manage/admins') ?>">Admin</a></li>
                                <li><a href="<?= base_url('index.php/administrator/manage/users') ?>">User</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
