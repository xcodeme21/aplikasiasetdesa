...
$tahun = $this->m_user->getInventaris($profile->id);
...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"><i class="mdi mdi-calendar"></i> Pilih Tahun Untuk Mencetak Inventaris Aset Desa</h5>
                </div>
                <form action="<?= base_url('index.php/user/assets/print') ?>" method="post">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="sekretaris" class="col-sm-4 col-form-label text-right">Nama Sekretaris Desa</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="sekretaris" id="sekretaris" autocomplete="off" spellcheck="false" required>
                            </div>
                        </div>
                        <div class="form-group row">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"><i class="mdi mdi-calendar"></i> Cetak Semua Inventaris Desa</h5>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <div class="radio">
                            <label><input type="radio" name="optradio"> Cetak Semua Inventaris</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <form action="<?= base_url('index.php/user/assets/print') ?>" method="post">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="sekretaris" class="col-sm-3 col-form-label text-right">Nama Sekretaris Desa</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="sekretaris" id="sekretaris" autocomplete="off" spellcheck="false" required>
                            </div>
                        </div>
